...
class MainStat extends StatelessWidget {
  ...
  const MainStat({super.key, required this.region, required this.primaryColor, required this.isExpanded});
              ...
              builder: (context, snapshot) {
                ...
                return Column(
                  children: [
                    ...
                    SizedBox(height: 20.0),
                    Text(status.label, style: ts.copyWith(fontWeight: FontWeight.w700)),
                    Text(
                      status.comment,
                      style: ts.copyWith(
